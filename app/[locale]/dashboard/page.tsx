      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        {isTrialExpired && (
          <div className="bg-red-50 border border-red-200 rounded-xl px-5 py-4 text-center">
            <p className="text-red-800 font-semibold mb-2">Your trial has ended</p>
            <p className="text-red-600 text-sm mb-3">Subscribe to continue your relational journey.</p>
            <Link
              href={`/${locale}/subscribe`}
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">How are things between you two today?</p>
        </div>
        ...
        >
          <p className="text-xl font-bold">Talk to Zerova</p>
          <p className="text-teal-100 mt-1 text-sm">
            Just start talking — Zerova detects what you need
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { emoji: '🌊', label: 'Safe Space', desc: 'Process a difficult moment', mode: 'safe_space' },
            { emoji: '🧭', label: 'Coach', desc: 'Learn a specific skill', mode: 'coach' },
            { emoji: '✨', label: 'Check-in', desc: 'Quick daily pulse', mode: 'checkin' },
          ].map(m => (
            <Link
              key={m.mode}
